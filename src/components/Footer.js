    ...
    <div style={{backgroundColor:"gray"}}>
        <div className='container'>
            <div className='row align-items-center p-4'>
                ...
                <div className='col m-3' style={{color:"black"}} >
                            <h4 >Profile_Info</h4>
                            <p> <strong style={{ marginLeft:"10px"}} > <CgProfile /></strong ><span style={{marginLeft:"10px"}}> Vikas Gajbhiye</span></p>
                            <p> <strong style={{ marginLeft:"10px"}}> <MdOutlineEmail /> </strong><span style={{marginLeft:"10px"}}> gajbhiye.vikas29@gmail.com</span></p>
                            <p> <strong style={{ marginLeft:"10px"}}> <MdOutlineWifiCalling3 /></strong><span style={{marginLeft:"10px"}}> 7709008992</span></p>
                            <p> <strong style={{ marginLeft:"10px"}}> <SlLocationPin /></strong> <span style={{marginLeft:"10px"}}> Pune Mahatrashtra India</span></p>
                </div>
            </div>  
        </div> 
        <div className='row text-center' style={{backgroundColor:"blueviolet"}} >
                <div className='col '>
                    <small >© Copyright "vikasgajbhiye29" All Rights Reserved</small>
                </div>
            </div>   
    </div>
  )
